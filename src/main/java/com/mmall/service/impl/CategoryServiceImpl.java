...
public class CategoryServiceImpl implements ICategoryService {
    ...
    public ServerResponse addCategory(String categoryName, Integer parentId) {
        if ( parentId == null || StringUtils.isBlank(categoryName)) {
            return ServerResponse.createByErrorCodeMessage(ResponseCode.NEED_LOGIN.getCode(), "添加品类参数错误");
        }
    ...
    public ServerResponse updateCategoryName(Integer categoryId, String categoryName) {
        if (categoryId == null || StringUtils.isBlank(categoryName)) {
            return ServerResponse.createByErrorCodeMessage(ResponseCode.NEED_LOGIN.getCode(), "更新品类名字参数错误");
        }
        Category category = new Category();
    ...
    private void findChildrenCategory(Set<Category> set, Integer categoryId) {
